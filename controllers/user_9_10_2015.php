...
class User extends CI_Controller {
	...
	public function index()
	{
		...
		public function editUser($id,$managerid="") {
				$data = array();
		...
		public function add_user()
		{
			  ...
			  $this->form_validation->set_rules('City','City','required|alpha|xss_clean');
			  $this->form_validation->set_rules('State','State','required|alpha|xss_clean');
			  $this->form_validation->set_rules('Zip','Zip','required|numeric|xss_clean|max_length[5]');
		 ...
		 public function delete_user()
		{
		 ...
		 //  This function is checking Email Id already Exits for Not .. ( Callback function )
			...
			{
			$data = array();	
			$user_list = $this->user_model->get_manager_list_user();
			$data['user_list'] = $user_list;
			$data['right_panel'] = $this->load->view('common/right_panel', '', true);
			$data['common_header'] = $this->load->view('common/header', '', true);
			$data['common_footer'] = $this->load->view('common/footer', '', true);
