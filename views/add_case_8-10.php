						...
						<div class="panel panel-border top mt20 mb35">
							<div class="panel-body">
								...
								<div class="form-group">
									...
									<div class="col-lg-8">
									<input  name="CategoryofDispute" onkeyup="this.value=this.value.replace(/[^a-zA-Z\.\s]/g,'');" value="" class="form-control CategoryofDispute" type="text">
									</div>
								</div>
							</div>
						</div>
                                            ...
                                            <div class="col-md-6">
												<div class="panel panel-primary panel-border top mt20 mb35">
													<div class="panel-body bg-light dark">
														...
														Party Name :</label>
														<div class="col-lg-7">
														<input name="FirstParty" value="" class="form-control FirstParty" onkeyup="this.value=this.value.replace(/[^a-zA-Z\.\s]/g,'');" type="text">
														</div>
														</div> 
											...
											<div class="col-md-6">
												<div class="panel panel-primary panel-border top mt20 mb35">
													<div class="panel-body bg-light dark">
														...
														Firm Name :</label>
														<div class="col-lg-7">
														<input  name="FirstParty_firm_name" value="" class="form-control FirstParty_firm_name" onkeyup="this.value=this.value.replace(/[^a-zA-Z\.\s]/g,'');" type="text">
														</div>
														</div> 
													...
													<label class="col-lg-5 control-label">
														...
														Attorney Name :</label>
														<div class="col-lg-7">
														<input  name="AttorneyNameFirst_party" value="" class="form-control AttorneyNameFirst_party" onkeyup="this.value=this.value.replace(/[^a-zA-Z\.\s]/g,'');" type="text">
														</div>
														</div> 
                                            ...
                                            <div class="col-md-6">
												<div class="panel panel-primary panel-border top mt20 mb35">
													<div class="panel-body bg-light dark">
														...
														Party Name :</label>
														<div class="col-lg-7">
														<input  name="SecondParty" value="" class="form-control SecondParty" onkeyup="this.value=this.value.replace(/[^a-zA-Z\.\s]/g,'');" type="text">
														</div>
														</div> 
											...
											<div class="col-md-6">
												<div class="panel panel-primary panel-border top mt20 mb35">
													<div class="panel-body bg-light dark">
														...
														Firm Name :</label>
														<div class="col-lg-7">
														<input  name="SecondParty_firm_name" value="" class="form-control SecondParty_firm_name" onkeyup="this.value=this.value.replace(/[^a-zA-Z\.\s]/g,'');" type="text">
														</div>
														</div> 
														...
														Attorney Name :</label>
														<div class="col-lg-7">
														<input  name="SecondPartyAttorneyName" onkeyup="this.value=this.value.replace(/[^a-zA-Z\.\s]/g,'');"  value="" class="form-control SecondPartyAttorneyName" type="text">
														</div>
														</div> 
