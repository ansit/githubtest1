			...
			<form class="form-horizontal" role="form">
                    <div class="col-md-12">
                        <div class="panel">
							...
							<!----													
			  			    <a class="btn btn-success btn-xs" href="<?php echo base_url();?>case_management/viewcase/<?php echo $active_case_list[$i]->CaseID?>">
				          ...
				          <a class="btn btn-danger btn-xs case" id="caseId_<?php echo $active_case_list[$i]->CaseID?>" href="javascript:void(0)">
							...
							<!----													
			  			    <a class="btn btn-success btn-xs" href="<?php echo base_url();?>case_management/viewcase/<?php echo $close_case_list[$i]->CaseID?>">
																				<i class="fa fa-eye"></i> View
								  											</a> ---->
