															...
															<table class="table table-bordered table-striped table-hover">
																...
																<tbody>
																 <?php for($i=0;$i<count($new_case_list);$i++) { ?>
																    ...
																    <td> <?php echo $new_case_list[$i]->FirstPArtyPhone?></td>
                                                                    <td><?php echo $new_case_list[$i]->SocendPArtyPhone?></td>
			      			                                        <td style="width:250px;">
																		<a class="btn btn-success btn-xs purple" href="<?php echo base_url();?>cases/editcase/<?php echo $new_case_list[$i]->CaseID?>">
																		<i class="fa fa-pencil"></i> Edit
																		</a>
																		<!-------	
																		<a class="btn btn-success btn-xs" href="<?php echo base_url();?>cases/viewcase/<?php echo $new_case_list[$i]->CaseID?>">
