					  ...
					  <div class="panel panel-body form-horizontal">
						<table class="table  table-bordered">
							<tr>
								...
								<tbody>
									<tr>
										<td class='colorrow<?php echo isset($firstep1->status)?$firstep1->status:"";?>'> <a href="<?php echo base_url().'manager_dashboard/viewcasedetails/'.$caseItem[0]->CaseID.'/1/1';?>"><span class="tablelink"><strong>Step 1:</strong> User #1 Input information (click here to see what the user has input)</span></a></td>
									...
									<tr>
										<td class='colorrow<?php echo isset($secstep1->status)?$secstep1->status:"";?>'><a href="<?php echo base_url().'manager_dashboard/viewcasedetails/'.$caseItem[0]->CaseID.'/2/1'?>"><span class="tablelink"><strong>Step 1:</strong> User #2 Input information (click here to see what the user has input)</span></a></td>
									...
									<tr>
										<td class='colorrow<?php echo isset($firstep2->status)?$firstep2->status:"";?>'><a href="<?php echo base_url().'manager_dashboard/viewcasedetails/'.$caseItem[0]->CaseID.'/1/2'?>"><span class="tablelink"><strong>Step 2:</strong> User #1 Responsive Module (click here to see what the user has input)</span></a></td>
									...
									<tr>
										<td class='colorrow<?php echo isset($secstep2->status)?$secstep2->status:"";?>'><a href="<?php echo base_url().'manager_dashboard/viewcasedetails/'.$caseItem[0]->CaseID.'/2/2'?>"><span class="tablelink"><strong>Step 2:</strong> User #2 Responsive Module (click here to see what the user has input)</span></a></td>
