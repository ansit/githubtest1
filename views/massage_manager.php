		...
		<div class="topbar-left">
			<ol class="breadcrumb">
				<li class="crumb-active">
					<a href="<?php echo base_url(); ?>user/massage/<?php echo $userid?>"> Conversation </a>
				</li>
			</ol>
		</div>
	</header>
					...
					<div class="row-fluid"><div class="span8" style="margin-left:120px;">	<link href="<?=$this->config->base_url()?>media/assets/css/style_chat.css" rel="stylesheet" type="text/css"/>
						...
						<div class="portlet-body" id="chats">
							...
							<div class="megachat"  style="height: 200px; overflow: auto;" data-always-visible="1" data-rail-visible1="1">
								...
								?>
									<li  class="<?php echo $align?>" data-msgid="<?php echo $view->MESSAGE_ID?>">
										...
										<div class="message">
											...
											<span class="body">
											<?php echo stripslashes($view->DISCUSSION);?>
											</span>
										</div>
									</li>
								<?php endforeach;?>	
							...
							echo form_open('user/setmessage/'.$userid,$attributes);?>
							<div class="chat-form">
...
setInterval(function(){
   ...
   retrivechat(managerid,userid,lastid,1);
},1000);
</script>
