                ...
                <?php if($session_data['User_type']==1){?>
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>manager">
                            ...
                            <span class="sidebar-title"> Manager </span>
                        </a>
						
                    </li>
					<li>
                         <a href="<?php echo base_url();?>manager/manager_cases">
						    <span class="glyphicons glyphicons-book"></span>
							<span class="sidebar-title"> Manager Case</span>  
						 </a>
                    </li>
					<!--<li>
                        <a href="<?php //echo base_url(); ?>time_tracking">
                            <span class="glyphicons glyphicons-clock"></span>
                            <span class="sidebar-title"> Time Tracking </span>
                        </a>
                    </li>-->
					<li>
						...
						<ul class="nav sub-nav">
                            <li>
                                <a href="<?php echo base_url();?>case_sequence">
                                    <span class="glyphicons glyphicons-book"> Dynamic Form</span>  </a>
                            </li>
                          <!--  <li>
                                <a href="<?php echo base_url();?>case_sequence/information_module">
                                    <span class="glyphicons glyphicons-show_big_thumbnails"> Information Module</span>
									</a>
                            </li>-->
                            <li>
                                <a href="#">
                                    <span class="glyphicons glyphicons-sampler">	 Report </span> </a>
                            </li>
                        </ul>
					...
					<li>
						<a href="<?php echo base_url();?>assign_cases_sequence">
							<span class="glyphicons glyphicons-log_book"></span>
							  <span class="sidebar-title">Assign Case sequence</span> </a>
					</li>
                    <?php }?>
<!---******************************* Managers Module ****************************---->
					...
					<li>
                        <a href="<?php echo base_url();?>user/message_list">
                            <span class="glyphicons glyphicons-cup"></span>
                            <span class="sidebar-title"> Conversation   </span>
                        </a>
                    </li>
