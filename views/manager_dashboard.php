...
<body class="dashboard-page sb-l-o sb-r-c">
		...
		<div class="topbar-left">
			<ol class="breadcrumb">
				<li class="crumb-active">
					<a href="<?php echo base_url(); ?>manager_dashboard/manager_user">Dashboard</a>
				</li>
			</ol>
		</div>
	</header>
    ...
    <div id="content" class="animated fadeIn">
        <div class="row">
			<!---<a href="<?php echo base_url(); ?>manager" style="color:black"><div class="col-sm-4 col-xl-3">
			 ...
			 <?php if($this->session->flashdata('msg')){ ?> 
                       ...
                       <?php echo $this->session->flashdata('msg'); ?>
                        ...
                        <?php  }  ?>  
			<a href="<?php echo base_url();?>user/manager_user_list/<?php echo $ManagerAssigned; ?>" style="color:black"><div class="col-sm-6 col-xl-3">
				<div class="panel panel-tile text-center br-a br-grey">
					<div class="panel-body btn-dark">
			...
			<a href="<?php echo base_url(); ?>assign_cases" style="color:black"><div class="col-sm-6 col-xl-3">
				<div class="panel panel-tile text-center br-a br-grey">
					<div class="panel-body btn-dark">
			...
			<form class="form-horizontal" action="" method="post">
                    <div class="col-md-12">
                        <div class="panel">
                            <h2 style="padding:18px; 10px; 10px; 10px;"> Assign Case </h2>
																...
																<tbody>
																 ...
																 <?php for($i=0;$i<count($active_case_list);$i++) {  ?>
																	...
																	<tr>
																		...
																		<a onclick="return confirm('Are you sure to reject this case ?');" class="btn btn-warning btn-xs purple" href="<?php echo base_url();?>manager_dashboard/delete/<?php echo $active_case_list[$i]->CaseID?>">
 ...
 <script>
   $(document).ready(function(){
	  setInterval(function(){ checknewnotification(2);}, 3000);
   })
</script>          
