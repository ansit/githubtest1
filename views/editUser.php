...
<body class="dashboard-page sb-l-o sb-r-c">
 ...
 <header id="topbar">
		<div class="topbar-left">
			<ol class="breadcrumb">
				<li class="crumb-active">
					<a href="<?php echo base_url(); ?>user/editUser/<?php echo $user_data[0]->UserID; ?>">Edit User</a>
				</li>
			</ol>
		</div>
	</header>
                ...
                <div class="admin-form theme-info mw700" style="max-width: 100% !important;" id="login1">
                    ...
                    <div class="panel panel-info mt10 br-n">
                        ...
                        <?php } ?>
                          ...
                          echo form_open_multipart('user/edit_user/'.$user_data[0]->UserID);
                                ...
                                <div class="section row" style="margin-top:10px;">
                                    <div class="col-md-6">
                                        <label class="field prepend-icon">
                                            <input type="text" name="FirstName" class="gui-input FirstName"  value="<?php echo $user_data[0]->FirstName ?>"  placeholder="First name.">
                                    ...
                                    <div class="col-md-6">
                                        <label  class="field prepend-icon">
                                            <input type="text" name="LastName" class="gui-input LastName"  value="<?php echo $user_data[0]->LastName ?>"  placeholder="Last name...">
                        ...
                        <option value="law_firm"<?php if($user_data[0]->Position=='law_firm') {?> selected="selected" <?php }?>> Law firm </option>
								...
								<div class="section row">
                                    <div class="col-md-6">
                                        <label  class="field prepend-icon">
                                            <textarea name="Address"  class="gui-input Address"placeholder="Address"><?php echo $user_data[0]->Address ?></textarea>
                                    ...
                                    <div class="col-md-6">
                                        <label class="field prepend-icon">
                                            <input type="text" name="City" class="gui-input City" value="<?php echo $user_data[0]->City ?>"  placeholder="City">
                                            <label class="field-icon"><i class="fa fa-building"></i>
                                            </label>
                                        </label>
                                    </div>
								...
								<div class="section row">
                                    <div class="col-md-6">
                                        <label for="firstname" class="field prepend-icon">
                                            <input type="text" name="State" class="gui-input State"  value="<?php echo $user_data[0]->State ?>"  placeholder="State">
                                            <label  class="field-icon"><i class="fa fa-building"></i>
                                            </label>
                                        </label>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <label  class="field prepend-icon">
                                            <input type="text" name="Zip"  class="gui-input Zip" value="<?php echo $user_data[0]->Zip ?>" onKeyUp="this.value=this.value.replace(/[^0-9\.]/g,'');" maxlength="6" class="gui-input" placeholder="Zip">
                                ...
                                <div class="section">
                                    <label class="field prepend-icon">
                                        <input type="email" name="Email"  class="gui-input Email" value="<?php echo $user_data[0]->Email ?>" class="gui-input" placeholder="Email address">
                                ...
                                <div class="section">
                                    <label  class="field prepend-icon">
                                        <input type="password" name="Password" class="gui-input Password" value="<?php echo $user_data[0]->Password ?>"  placeholder="Create a password">
								...
								<div class="section row">
                                    <div class="col-md-6">
                                        <label class="field prepend-icon">
                                            <input type="text" name="PhoneNumber" class="gui-input PhoneNumber" maxlength="13"  onKeyUp="this.value=this.value.replace(/[^0-9\.]/g,'');" value="<?php echo $user_data[0]->PhoneNumber ?>" placeholder="Phone Number">
                                            <label  class="field-icon">+1</i>
                                            </label>
                                        </label>
                                    </div>
                                    <!-- end section -->
                                    ...
                                    <div class="col-md-6">
                                        <label  class="field prepend-icon">
                                            <input type="text" name="Firm_CompanySize"  class="gui-input Firm_CompanySize" value="<?php echo $user_data[0]->Firm_CompanySize ?>"  placeholder="Firm_CompanySize">
                                            <label  class="field-icon"><i class="fa fa-building"></i>
                                            </label>
                                        </label>
                                    </div>
								...
								<div class="section">
                                    <label class="field prepend-icon">
                                        <textarea name="HowDidYouHearAboutUs" class="gui-input HowDidYouHearAboutUs"  placeholder="How Did You Hear About Us"> <?php echo $user_data[0]->HowDidYouHearAboutUs ?> </textarea>
   ...
   ><span class="checkbox"></span>personal injury </label>
                                         ...
                                         <label class="option block mt15">
                              <input type="checkbox" name="terms[]" value="corporate transactional"  <?php if(in_array('corporate transactional',$PracticeAreas_Arr)){?>checked<?php }?>> <span class="checkbox"></span>corporate transactional 
                                         </label>
                                         <label class="option block mt15"> 
                                        <input type="checkbox" name="terms[]" value="insurance litigation" <?php if(in_array('insurance litigation',$PracticeAreas_Arr)){?>checked<?php }?>> <span class="checkbox"></span>insurance litigation 
                                         </label>
                                         <label class="option block mt15"> 
                           <input type="checkbox" name="terms[]" value="intellectual property" <?php if(in_array('intellectual property',$PracticeAreas_Arr)){?>checked<?php }?> ><span class="checkbox"></span>intellectual property 
                                         </label>
                                        <label class="option block mt15">
             <input type="checkbox" name="terms[]" value="products liability" <?php if(in_array('products liability',$PracticeAreas_Arr)){?>checked<?php }?>> <span class="checkbox"></span>products liability 
                                         </label>
                                         <label class="option block mt15">  
                          <input type="checkbox" name="terms[]" value="environmental litigation" <?php if(in_array('environmental litigation',$PracticeAreas_Arr)){?>checked<?php }?>> <span class="checkbox"></span>environmental litigation 
                                         </label> 
                                     <label class="option block mt15">
                         <input type="checkbox" name="terms[]" value="labor and employment" <?php if(in_array('labor and employment',$PracticeAreas_Arr)){?>checked<?php }?>> <span class="checkbox"></span>labor and employment 
                                         </label>
                                         <label class="option block mt15"> 
    <input type="checkbox" name="terms[]" value="consumer litigation" <?php if(in_array('consumer litigation',$PracticeAreas_Arr)){?>checked<?php }?>> <span class="checkbox"></span>consumer litigation
                                         </label> 
                                       <label class="option block mt15">
       <input type="checkbox" name="terms[]" value="Other" id="law_other" <?php if(in_array('Other',$PracticeAreas_Arr)){?>checked<?php }?>><span class="checkbox"></span>Other 
								...
								<div class="section row">
								 ...
								 <div class="section">
									<label class="field select prepend-icon">
										<select  name="AreYouAnAttorneycom">
                                        <option value="" >Are You Attorney</option>
                       ...
                       <input type="checkbox" name="terms2[]" value="Real estate and construction"><span class="checkbox"></span>Real estate and construction
                          ...
                          <?php }?>      
                            ...
                            <div class="col-md-12" style="text-align:center; margin-bottom:50px;" >
                              <button class="btn active btn-success" type="submit" id="update"> <i class="fa fa-save"></i> Update</button>
                           <!--   <button class="btn active btn-warning" type="reset" onclick="return confirm('Are you sure want to Reset ?')"  > <i class="fa fa-save"></i> Reset</button>-->
                              <button class="btn active btn-system" type="button" onclick="goBack()" > <i class="fa fa-save"></i> Cancel</button>
                            </div>
